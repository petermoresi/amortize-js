#+SETUPFILE: Loan Calculator in JavaScript
#+NAME: Amortize.js
#+AUTHOR: Peter Moresi
#+DATE: <2014-09-26 Fri>
#+OPTIONS: ^:nil
...
#+NAME: amortize-js   
#+BEGIN_SRC js :exports none :noweb yes :tangle amortize.js
    <<pmt-function>>
...
#+END_SRC
* Demo
This page will not send any information to a remote server. The calculation is performed inside your browser.
